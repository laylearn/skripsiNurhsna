        ...
        <div class="col-md-5" data-aos="fade-up" data-aos-delay="200">
          <div class="row">
            <div class="col-md-10 ml-auto contact-info">
              <p><span style="font-size: 30px;" class="d-block"><strong>ALAMAT</strong>:</span> <span style="font-size: 35px;" class="text-black"> 38, Mardhika, Jl. Mutiara, Kel Rijali, Kec. Sirimau, Kota Ambon, Maluku 97123</span></p>
              <p><span style="font-size: 30px;" class="d-block"><strong>TELEPON</strong>:</span> <span style="font-size: 35px;" class="text-black">081240254387</span></p>
              <p><span style="font-size: 30px;" class="d-block"><strong>EMAIL</strong>:</span> <span style="font-size: 35px;" class="text-black"> info@cleanandcomort.com</span></p>
            </div>
          </div>
        </div>
      </div>
